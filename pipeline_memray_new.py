"""This file contains the pipeline that will be profiled by the memray package. This file implements the new version of CAIMAN (as opposed to pipeline_memray_old.py implementing the old version of CAIMAN). Because memray does not require any extra decorators or other objects to help it run, this code can also be imported to other files and run as is.
"""
